...
const steps = [
  ...
  },
  {
    ...
    description:
      "Deposit funds securely using multiple payment options.",
  },
  {
    title: "Start Trading",
    description:
...
>
  ...
  />
        ...
        <div className="text-center max-w-3xl mx-auto mb-28">
          <h2 className="text-4xl md:text-5xl font-semibold bg-gradient-to-br from-white/70 via-yellow-500 to-black/50 text-transparent bg-clip-text mb-4">
            CFD Explution
          </h2>
